  ...
  return (
    <section id="temoignages" className="relative py-32 px-4 bg-gray-50 dark:bg-[#080808] overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <p className="text-center text-[10px] text-gray-400 uppercase tracking-[0.2em] mb-12">
            Technologies utilisées
          </p>
          <div className="flex flex-wrap justify-center items-end gap-12 md:gap-16 lg:gap-20">
            {technologies.map((tech, i) => (
              <Motion.div
                ...
                className="flex flex-col items-center gap-3 text-gray-400 hover:text-[#0066FF] transition-colors cursor-pointer group"
              >
                <div className="p-4 rounded-2xl bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 group-hover:border-[#0066FF]/50 group-hover:shadow-lg group-hover:shadow-[#0066FF]/10 transition-all duration-300">
                  {tech.icon}
                </div>
