  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#050505] text-black dark:text-white py-20 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-4xl md:text-5xl font-black mb-8">Mentions Légales</h1>
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              Micro-entreprise<br />
              France<br /><br />
              Contact : <a href="https://wa.me/33635505374" className="text-[#0066FF] hover:underline">+33 6 35 50 53 74</a> (WhatsApp)
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              Pour toute question concernant ces mentions légales, vous pouvez nous contacter via WhatsApp au <a href="https://wa.me/33635505374" className="text-[#0066FF] hover:underline">+33 6 35 50 53 74</a>.
            </p>
          </section>
        </div>
      </div>
