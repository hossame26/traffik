        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-6 text-gray-600 dark:text-gray-300 space-y-2">
              <li><strong>Données de contact</strong> : nom, adresse email, numéro de téléphone (via WhatsApp)</li>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed mt-4">
              Pour exercer ces droits, contactez-nous via WhatsApp au <a href="https://wa.me/33635505374" className="text-[#0066FF] hover:underline">+33 6 35 50 53 74</a>.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              WhatsApp : <a href="https://wa.me/33635505374" className="text-[#0066FF] hover:underline">+33 6 35 50 53 74</a><br /><br />
